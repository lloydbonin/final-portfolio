...
export const experiences = [
  {
    id: 0,
    img: "https://firebasestorage.googleapis.com/v0/b/bookstour-27f8f.appspot.com/o/Items%2Fceo_logo.jpg?alt=media&token=52a59725-7904-4a02-b461-53f6a5bee162",
    role: "Data Analyst Intern",
    company: "Creative Entrepreneur Organization Inc.",
    date: "April 2023 - May 2023",
    desc: "Employed data visualization tools to effectively present insights from the data. Additionally, prepared reports and presentations summarizing findings and recommendations, and conducted data cleaning, validation, and quality assurance to ensure accuracy.",
    skills: [
      "Data Analysis",
      "Data Visualization",
      "Presentation Skills",
...
export const projects = [
  ...
  {
    id: 4,
    title: "Waste Management of the Philippines Analysis",
    date: "Jan 2023 - Mar 2023",
    description:
      "Preprocessed and augmented the dataset to improve model accuracy, trained the model, created API using model and Python, and used React web app for the project's front end. Achievements: Achieved an accuracy of 99.2% to accurately detect brain tumors from medical images.",
    image:
  ...
  {
    id: 5,
    title: "Number of Entrepreneurs in the Philippines Analysis",
    date: "Jan 2023 - Mar 2023",
    description:
      "Preprocessed and augmented the dataset to improve model accuracy, trained the model, created API using model and Python, and used React web app for the project's front end. Achievements: Achieved an accuracy of 99.2% to accurately detect brain tumors from medical images.",
    image:
